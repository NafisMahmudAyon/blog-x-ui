...
export default function Home() {
  ...
  const posts = [{ title: "title1", description: "description1" },
          ...
          {posts.map((post, index) =>{
            return (
              <RelatedPost key={index}>
                <a href="#abc" className="relative z-20"></a>
                <h3 className="flex-1 py-2 text-lg font-semibold leading-snug relative z-20">
                  {post.title}
                </h3>
                <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-600 relative z-20">
                  {post.description}
