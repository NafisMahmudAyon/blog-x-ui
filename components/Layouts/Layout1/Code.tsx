      ...
      <Blog key={index} className="relative bg-[#f2f7fb] pb-4">
        ...
        <Blog className='px-4'>
          ...
          <div className='flex gap-4 md:gap-6 items-center'>
            <AuthorBio className='flex gap-2 items-center relative z-20' profileImage={post.author.avatar} isLink name={post.author.name} profileLink={post.author.profileLink}>
