...
export const Excerpt = ({ tagName = "p", className = "", limitBy = "word", limit, children = "" }) => {
    const Tag = tagName;
    ...
    return (_jsxs(Tag, { className: `${className}`, children: [children != "undefined" && typeof children === "string" &&
